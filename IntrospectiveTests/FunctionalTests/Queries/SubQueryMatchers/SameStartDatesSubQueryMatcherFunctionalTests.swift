//
//  SameStartDatesSubQueryMatcherFunctionalTests.swift
//  IntrospectiveTests
//
...
class SameStartDatesSubQueryMatcherFunctionalTests: FunctionalTest {
	...
	func testGivenMostRecentOnlyIsTrueAndMultipleSubQuerySamplesAndMultipleQuerySamplesAndAllSamplesHaveStartAndEndDates_getSamples_returnsOnlyMatchingSamples() {
		...
		let subQuerySampleEndDate1 = querySampleEndDate1 + 3.hours
