//
//  EqualToSelectOneAttributeRestrictionUnitTests.swift
//  IntrospectiveTests
//
//  Created by Bryan Nova on 3/27/19.
...
final class EqualToSelectOneAttributeRestrictionUnitTests: UnitTest {

	private final var restriction: EqualToSelectOneAttributeRestriction!
	...
	final override func setUp() {
		...
		restriction = EqualToSelectOneAttributeRestriction(restrictedAttribute: attribute, value: value, valueAttribute: attribute)
	}
	...
	func testGivenSelectOneAttribute_init_setsRestrictionValueToFirstPossibleValue() {
		// when
		restriction = EqualToSelectOneAttributeRestriction(restrictedAttribute: attribute)
	...
	func testGivenSampleValueEqualToRestrictionValue_samplePasses_returnsTrue() throws {
		// given
	...
	func testGivenSampleValueNotEqualToRestrictionValue_samplePasses_returnsFalse() throws {
		// given
	...
	func testGivenSameClassWithDifferentAttributes_equalToOperator_returnsFalse() {
		// given
		let other = EqualToSelectOneAttributeRestriction(
