...
final class NotEqualToDosageAttributeRestrictionUnitTests: UnitTest {
	...
	func testGivenNilSampleValueAndValueIsNotNil_samplePasses_returnsTrue() throws {
		// given
		restriction.value = Dosage(2, "mg") as Any
	...
	func testGivenSameClassWithDifferentAttributes_equalToOperator_returnsFalse() {
		// given
		let other = NotEqualToDosageAttributeRestriction(
	...
	func testGivenSameClassWithSameRestrictedAttributeButDifferentValues_equalToOperator_returnsFalse() {
		...
		let other = NotEqualToDosageAttributeRestriction(
			...
			value: Dosage(restrictionValue.amount + 1, restrictionValue.unit))
	...
	func testGivenSameClassWithDifferentRestrictedAttribute_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = NotEqualToDosageAttributeRestriction(
			restrictedAttribute: DosageAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithDifferentAttributes_equalToRestriction_returnsFalse() {
		// given
		let otherRestriction: AttributeRestriction = NotEqualToDosageAttributeRestriction(
			restrictedAttribute: DosageAttribute(name: "not the same attribute"))
