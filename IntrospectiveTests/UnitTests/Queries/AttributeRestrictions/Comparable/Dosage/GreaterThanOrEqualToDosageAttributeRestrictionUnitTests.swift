//
//  GreaterThanOrEqualToDosageAttributeRestrictionUnitTests.swift
//  IntrospectiveTests
//
...
final class GreaterThanOrEqualToDosageAttributeRestrictionUnitTests: UnitTest {

	private typealias Me = GreaterThanOrEqualToDosageAttributeRestrictionUnitTests
	private static let valueAttribute = GreaterThanOrEqualToDosageAttributeRestriction.valueAttribute
	private static let restrictedAttribute = DosageAttribute(name: "restricted")

	private var restriction: GreaterThanOrEqualToDosageAttributeRestriction!
	...
	func testGivenSameClassWithDifferentRestrictedAttribute_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: DosageAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameRestrictedAttributeButDifferentValue_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: Dosage(restriction.value.amount + 1, "mL"))
	...
	func testGivenSameTypeWithAllSameAttributes_equalToAttributed_returnsTrue() {
		// given
		let otherAttributed: Attributed = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: DosageAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameRestrictedAttributeButDifferentValues_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: Dosage(restriction.value.amount + 1, "mL"))
	...
	func testGivenSameTypeWithAllSameAttributes_equalToRestriction_returnsTrue() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalTo_returnsFalse() {
		// given
		let otherAttributed = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: DosageAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameRestrictedAttributeButDifferentValues_equalTo_returnsFalse() {
		// given
		let otherAttributed = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: Dosage(restriction.value.amount + 1, "mL"))
	...
	func testGivenSameTypeWithAllSameAttributes_equalTo_returnsTrue() {
		// given
		let otherAttributed = GreaterThanOrEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: restriction.value)
