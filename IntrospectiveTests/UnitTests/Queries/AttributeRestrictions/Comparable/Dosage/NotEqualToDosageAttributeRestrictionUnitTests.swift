//
//  NotEqualToDosageAttributeRestrictionUnitTests.swift
//  IntrospectiveTests
//
...
class NotEqualToDosageAttributeRestrictionUnitTests: UnitTest {

	private typealias Me = NotEqualToDosageAttributeRestrictionUnitTests
	private static let valueAttribute = NotEqualToDosageAttributeRestriction.valueAttribute
	private static let restrictedAttribute = DosageAttribute(name: "restricted")

	private var restriction: NotEqualToDosageAttributeRestriction!

	final override func setUp() {
		super.setUp()
		restriction = NotEqualToDosageAttributeRestriction(restrictedAttribute: Me.restrictedAttribute)
	}
	...
	func testGivenSameClassWithDifferentRestrictedAttribute_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = NotEqualToDosageAttributeRestriction(restrictedAttribute: DosageAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameRestrictedAttributeButDifferentValue_equalToAttributed_returnsFalse() {
		...
		let otherAttributed: Attributed = NotEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: Dosage(restrictionValue.amount + 1, restrictionValue.unit))
	...
	func testGivenSameTypeWithAllSameAttributes_equalToAttributed_returnsTrue() {
		// given
		let restrictionValue = restriction.value as! Dosage
		let otherAttributed: Attributed = NotEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: restrictionValue)
	...
	func testGivenSameClassWithDifferentAttributes_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = NotEqualToDosageAttributeRestriction(restrictedAttribute: DosageAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameRestrictedAttributeButDifferentValues_equalToRestriction_returnsFalse() {
		// given
		let restrictionValue = restriction.value as! Dosage
		let otherAttributed: AttributeRestriction = NotEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: Dosage(restrictionValue.amount + 1, restrictionValue.unit))
	...
	func testGivenSameTypeWithAllSameAttributes_equalToRestriction_returnsTrue() {
		// given
		let restrictionValue = restriction.value as! Dosage
		let otherAttributed: AttributeRestriction = NotEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: restrictionValue)
	...
	func testGivenSameClassWithDifferentAttributes_equalTo_returnsFalse() {
		// given
		let otherAttributed = NotEqualToDosageAttributeRestriction(restrictedAttribute: DosageAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameRestrictedAttributeButDifferentValues_equalTo_returnsFalse() {
		// given
		let restrictionValue = restriction.value as! Dosage
		let otherAttributed = NotEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: Dosage(restrictionValue.amount + 1, restrictionValue.unit))
	...
	func testGivenSameTypeWithAllSameAttributes_equalTo_returnsTrue() {
		// given
		let restrictionValue = restriction.value as! Dosage
		let otherAttributed = NotEqualToDosageAttributeRestriction(restrictedAttribute: restriction.restrictedAttribute, value: restrictionValue)
