...
// sourcery:inline:auto:MoodMock.autoMocked
    ...
    public static var isSearchable: Bool {
		get {	MoodMock.invocations.append(.p_isSearchable_get); return MoodMock.__p_isSearchable ?? givenGetterValue(.p_isSearchable_get, "MoodMock - stub value for isSearchable was not defined") }
		@available(*, deprecated, message: "Using setters on readonly variables is deprecated, and will be removed in 3.1. Use Given to define stubbed property return value.")
		set {	MoodMock.__p_isSearchable = newValue }
	}
