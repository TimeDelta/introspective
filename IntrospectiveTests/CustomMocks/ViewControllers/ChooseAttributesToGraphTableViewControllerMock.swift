...
// sourcery:inline:auto:ChooseAttributesToGraphTableViewControllerMock.autoMocked
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {            case (.p_notificationToSendWhenFinished_get,.p_notificationToSendWhenFinished_get): return Matcher.ComparisonResult.match
            ...
            case (.p_allowedAttributes_get,.p_allowedAttributes_get): return Matcher.ComparisonResult.match
			case (.p_allowedAttributes_set(let left),.p_allowedAttributes_set(let right)): return Matcher.ComparisonResult([Matcher.ParameterComparisonResult(Parameter<[Attribute]?>.compare(lhs: left, rhs: right, with: matcher), left, right, "newValue")])
            case (.p_selectedAttributes_get,.p_selectedAttributes_get): return Matcher.ComparisonResult.match
			case (.p_selectedAttributes_set(let left),.p_selectedAttributes_set(let right)): return Matcher.ComparisonResult([Matcher.ParameterComparisonResult(Parameter<[Attribute]?>.compare(lhs: left, rhs: right, with: matcher), left, right, "newValue")])
            default: return .none
            }
        }
        ...
        func assertionName() -> String {
            ...
            case .p_allowedAttributes_get: return "[get] .allowedAttributes"
			case .p_allowedAttributes_set: return "[set] .allowedAttributes"
            case .p_selectedAttributes_get: return "[get] .selectedAttributes"
			case .p_selectedAttributes_set: return "[set] .selectedAttributes"
            }
        }
    }
