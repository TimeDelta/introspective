//
//  ChooseSampleTypeViewControllerMock.swift
//  IntrospectiveTests
//
...
// sourcery:inline:auto:ChooseSampleTypeViewControllerMock.autoMocked
	...
	private var __p_selectedSampleType: (Sample.Type)?


    public var notificationToSendOnAccept: NotificationName! {
		get {	invocations.append(.p_notificationToSendOnAccept_get); return __p_notificationToSendOnAccept ?? optionalGivenGetterValue(.p_notificationToSendOnAccept_get, "ChooseSampleTypeViewControllerMock - stub value for notificationToSendOnAccept was not defined") }
    ...
    fileprivate enum MethodType {
        case p_selectedSampleType_get
		case p_selectedSampleType_set(Parameter<Sample.Type?>)
        ...
        func intValue() -> Int {
            switch self {
            case .p_selectedSampleType_get: return 0
    ...
    open class Given: StubbedMethod {
        ...
        public static func selectedSampleType(getter defaultValue: Sample.Type?...) -> PropertyStub {
            return Given(method: .p_selectedSampleType_get, products: defaultValue.map({ StubProduct.return($0 as Any) }))
        }
    ...
    public struct Verify {
        ...
        public static var selectedSampleType: Verify { return Verify(method: .p_selectedSampleType_get) }
		public static func selectedSampleType(set newValue: Parameter<Sample.Type?>) -> Verify { return Verify(method: .p_selectedSampleType_set(newValue)) }
