...
// sourcery:inline:auto:MedicationDoseEditorViewControllerMock.autoMocked
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {            case (.p_medicationDose_get,.p_medicationDose_get): return Matcher.ComparisonResult.match
			case (.p_medicationDose_set(let left),.p_medicationDose_set(let right)): return Matcher.ComparisonResult([Matcher.ParameterComparisonResult(Parameter<MedicationDose?>.compare(lhs: left, rhs: right, with: matcher), left, right, "newValue")])
            case (.p_medication_get,.p_medication_get): return Matcher.ComparisonResult.match
			case (.p_medication_set(let left),.p_medication_set(let right)): return Matcher.ComparisonResult([Matcher.ParameterComparisonResult(Parameter<Medication?>.compare(lhs: left, rhs: right, with: matcher), left, right, "newValue")])
        ...
        func assertionName() -> String {
            switch self {
            case .p_medicationDose_get: return "[get] .medicationDose"
			case .p_medicationDose_set: return "[set] .medicationDose"
            case .p_medication_get: return "[get] .medication"
			case .p_medication_set: return "[set] .medication"
