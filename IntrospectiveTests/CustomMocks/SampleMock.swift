...
// sourcery:inline:auto:SampleMock.autoMocked
    ...
    public static var isSearchable: Bool {
		get {	SampleMock.invocations.append(.p_isSearchable_get); return SampleMock.__p_isSearchable ?? givenGetterValue(.p_isSearchable_get, "SampleMock - stub value for isSearchable was not defined") }
		@available(*, deprecated, message: "Using setters on readonly variables is deprecated, and will be removed in 3.1. Use Given to define stubbed property return value.")
		set {	SampleMock.__p_isSearchable = newValue }
	}
