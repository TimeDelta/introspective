...
public class DoesNotHaveTagAttributeRestriction: AnyAttributeRestriction, SingleTagAttributeRestriction, Equatable {
	...
	public override var attributedName: String { "Not tagged with" }
	public override var description: String { "Not tagged with '\(tag.name)'" }
	...
	public override func copy() -> AttributeRestriction {
		DoesNotHaveTagAttributeRestriction(tag: tag, restrictedAttribute: restrictedAttribute)
	}
	...
	public final func equalTo(_ other: DoesNotHaveTagAttributeRestriction) -> Bool {
		restrictedAttribute.equalTo(other.restrictedAttribute) && tag == other.tag
	}
}
