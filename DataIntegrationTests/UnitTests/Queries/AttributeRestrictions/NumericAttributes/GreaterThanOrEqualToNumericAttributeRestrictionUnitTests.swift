//
//  GreaterThanOrEqualToNumericAttributeRestrictionUnitTests.swift
...
class GreaterThanOrEqualToNumericAttributeRestrictionUnitTests: UnitTest {

	fileprivate typealias Me = GreaterThanOrEqualToNumericAttributeRestrictionUnitTests
	fileprivate static let valueAttribute = GreaterThanOrEqualToNumericAttributeRestriction.valueAttribute
	fileprivate static var restrictedAttribute = IntegerAttribute(name: "value")

	fileprivate var restriction: GreaterThanOrEqualToNumericAttributeRestriction!

	override func setUp() {
		super.setUp()
		restriction = GreaterThanOrEqualToNumericAttributeRestriction(attribute: Me.restrictedAttribute)
	}
	...
	func testGivenSameClassWithDifferentAttributes_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = GreaterThanOrEqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = GreaterThanOrEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalToAttributed_returnsTrue() {
		// given
		let otherAttributed: Attributed = GreaterThanOrEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanOrEqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanOrEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalToRestriction_returnsTrue() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanOrEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalTo_returnsFalse() {
		// given
		let otherAttributed = GreaterThanOrEqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalTo_returnsFalse() {
		// given
		let otherAttributed = GreaterThanOrEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalTo_returnsTrue() {
		// given
		let otherAttributed = GreaterThanOrEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
