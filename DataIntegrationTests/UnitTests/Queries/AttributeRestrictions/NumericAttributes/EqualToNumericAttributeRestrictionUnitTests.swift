//
//  EqualToNumericAttributeRestrictionUnitTests.swift
...
class EqualToNumericAttributeRestrictionUnitTests: UnitTest {

	fileprivate typealias Me = EqualToNumericAttributeRestrictionUnitTests
	fileprivate static let valueAttribute = EqualToNumericAttributeRestriction.valueAttribute
	fileprivate static var restrictedAttribute = IntegerAttribute(name: "value")

	fileprivate var restriction: EqualToNumericAttributeRestriction!

	override func setUp() {
		super.setUp()
		restriction = EqualToNumericAttributeRestriction(attribute: Me.restrictedAttribute)
	}
	...
	func testGivenSameClassWithDifferentAttributes_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = EqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = EqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalToAttributed_returnsTrue() {
		// given
		let otherAttributed: Attributed = EqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = EqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = EqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalToRestriction_returnsTrue() {
		// given
		let otherAttributed: AttributeRestriction = EqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalTo_returnsFalse() {
		// given
		let otherAttributed = EqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalTo_returnsFalse() {
		// given
		let otherAttributed = EqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalTo_returnsTrue() {
		// given
		let otherAttributed = EqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
