//
//  GreaterThanNumericAttributeRestrictionUnitTests.swift
...
class GreaterThanNumericAttributeRestrictionUnitTests: UnitTest {

	fileprivate typealias Me = GreaterThanNumericAttributeRestrictionUnitTests
	fileprivate static let valueAttribute = GreaterThanNumericAttributeRestriction.valueAttribute
	fileprivate static var restrictedAttribute = IntegerAttribute(name: "value")

	fileprivate var restriction: GreaterThanNumericAttributeRestriction!

	override func setUp() {
		super.setUp()
		restriction = GreaterThanNumericAttributeRestriction(attribute: Me.restrictedAttribute)
	}
	...
	func testGivenSameClassWithDifferentAttributes_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = GreaterThanNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = GreaterThanNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalToAttributed_returnsTrue() {
		// given
		let otherAttributed: Attributed = GreaterThanNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalToRestriction_returnsTrue() {
		// given
		let otherAttributed: AttributeRestriction = GreaterThanNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalTo_returnsFalse() {
		// given
		let otherAttributed = GreaterThanNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalTo_returnsFalse() {
		// given
		let otherAttributed = GreaterThanNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalTo_returnsTrue() {
		// given
		let otherAttributed = GreaterThanNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
