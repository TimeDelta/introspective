//
//  NotEqualToNumericAttributeRestrictionUnitTests.swift
...
class NotEqualToNumericAttributeRestrictionUnitTests: UnitTest {

	fileprivate typealias Me = NotEqualToNumericAttributeRestrictionUnitTests
	fileprivate static let valueAttribute = NotEqualToNumericAttributeRestriction.valueAttribute
	fileprivate static var restrictedAttribute = IntegerAttribute(name: "value")

	fileprivate var restriction: NotEqualToNumericAttributeRestriction!

	override func setUp() {
		super.setUp()
		restriction = NotEqualToNumericAttributeRestriction(attribute: Me.restrictedAttribute)
	}
	...
	func testGivenSameClassWithDifferentAttributes_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = NotEqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalToAttributed_returnsFalse() {
		// given
		let otherAttributed: Attributed = NotEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalToAttributed_returnsTrue() {
		// given
		let otherAttributed: Attributed = NotEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = NotEqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalToRestriction_returnsFalse() {
		// given
		let otherAttributed: AttributeRestriction = NotEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalToRestriction_returnsTrue() {
		// given
		let otherAttributed: AttributeRestriction = NotEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
	...
	func testGivenSameClassWithDifferentAttributes_equalTo_returnsFalse() {
		// given
		let otherAttributed = NotEqualToNumericAttributeRestriction(attribute: IntegerAttribute(name: "not the same attribute"))
	...
	func testGivenSameClassWithSameAttributeButDifferentSubstrings_equalTo_returnsFalse() {
		// given
		let otherAttributed = NotEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value + 1)
	...
	func testGivenSameMatcherTypeWithAllSameAttributes_equalTo_returnsTrue() {
		// given
		let otherAttributed = NotEqualToNumericAttributeRestriction(attribute: restriction.restrictedAttribute, value: restriction.value)
