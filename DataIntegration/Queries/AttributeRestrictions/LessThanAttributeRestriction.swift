//
//  LessThanAttributeRestriction.swift
//  DataIntegration
//
...
public class LessThanAttributeRestriction: AnyAttributeRestriction {

	fileprivate typealias Me = LessThanAttributeRestriction
	...
	public override func value(of attribute: Attribute) throws -> Any {
		if attribute.name == Me.valueAttribute.name { return value }
		if attribute.name == restrictedAttribute.name { return restrictedAttribute }
